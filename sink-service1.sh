...
INPUT=$SNAP_DATA/sink1.conf

OLDIFS=$IFS
IFS=','
[ ! -f $INPUT ] && { echo "Sink 1 does not have a configuration file."; exit 99; }
...
#launch sinkService
$SNAP/sinkService  -p $sinkPath -b $sinkBaud -i 1

#If we get here the sinkService errored out.
echo "Sink service 1 exited."
